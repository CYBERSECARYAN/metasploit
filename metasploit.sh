...
gem install lolcat
	...
	echo " "
	echo " "
	echo "    Author          :  CYBER SEC "
	sleep 1
	echo " "
	echo "    YouTube Channel :  https://www.youtube.com/channel/UCrmhzytKiy3ddJCPfpGebqg "
	echo " "
	sleep 1
	echo "  Guys just be supporting me and motivating " | lolcat -a
 	echo "  me for more new tools and much more things " | lolcat -a
	echo " "
	echo " "
	echo "		           - Thank you to all" | lolcat -a
	echo "	          	      my subscribers" | lolcat -a
	echo " "
	sleep 1
	echo " "
	echo -n " press enter to continue........." | lolcat -a
	read FA
...
clear
echo "           ___[+ + + + ]____"
echo " ________[__  CYBER SEC  ___]________"
echo " |           [          ]            |"
echo " | For more information u can visit  |"
echo " |    to my channel CYBER SEC        |"
echo " +-----------------------------------+"
echo " |         [   (^_^ )/   ]           |"
echo " |                                   |"
...
echo "msfconsole" | lolcat -a | pv -qL 10
